...
(1, 'BeritaIchi', 'BeritaIchi', 'Latest Indonesia and World News Today, the Latest Most Complete Daily News Regarding Politics, Economy, Travel, Technology, Automotive, ...', 'BeritaIchi', 'c551664b65bad27d6b56ac71bfdd016f.png');
...
(1, '127.0.0.1', 'administrator', '$2y$12$QUM2OeQCZclQqJIhZKKMt.Aq8dA3Y7eIzjtXsyr.xuE0kDjfj8SLS', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1597292859, 1, 'Berita', 'Ichi', NULL, '0123456789');
