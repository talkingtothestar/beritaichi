<div class="col-lg-4">
   <div class="right_sidebar">
      ...
      <aside class="r_widgets social_widgets mt-5">
         ...
         <ul class="list">
            <li><a href="https://www.facebook.com/"><i class="fa fa-facebook"></i>IchiProject<span>Like our page</span></a></li>
            <li><a href="https://twitter.com/"><i class="fa fa-twitter"></i>IchiProject<span>Follow Us</span></a></li>
            <li><a href="https://www.youtube.com/"><i class="fa fa-youtube-play"></i>IchiProject<span>Subscribe</span></a></li>
         </ul>
      </aside>
